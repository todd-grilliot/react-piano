...
function App() {
    ...
    function toggleModal(e) {
        ...
        else if (e.target.className.includes("close-modal"))
            setShowModal(!showModal);
    }
    return (
        <div className="App">
            <Header toggleKeyNames={toggleKeyNames} toggleModal={toggleModal} />
            <div className="keyboard">
                <KeyBoard keyNameToggle={keyNameToggle} />
            </div>
            {showModal && <HelpModal toggleModal={toggleModal} />}
        </div>
    );
}
